...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	if ( is_multisite() ) {
		...
		$login_header_url   = __( 'https://axonista.com/hub' );
		$login_header_title = __( 'Central Hub' );
	}
	...
	<div id="login">
		<h1><a href="<?php echo esc_url( $login_header_url ); ?>" title="<?php echo esc_attr( $login_header_title ); ?>" tabindex="-1"></a></h1>
	<?php
